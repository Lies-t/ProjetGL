...
public class AssertTest extends TestCase {
	...
	public void testAssertSame() {
        ...
        assertSame(o, o);
        try {
            assertSame( Integer.reverse(1), Integer.reverse(1));
        } catch (AssertionFailedError e) {
            return;
        }
        fail();
	...
	public void testAssertNotSame() {
        assertNotSame(Integer.valueOf(1), null);
        assertNotSame(null, Integer.valueOf(1));
        //assertNotSame(Integer.valueOf(1), Integer.valueOf(1));
        try {
